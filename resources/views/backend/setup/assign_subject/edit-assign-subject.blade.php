            ...
            <div class="card">
              <div class="card-header bg-primary">
               ...
               <div class="card-body">
                    ...
                    <form action="{{route('setups.assign.subject.update',$data[0]->class_id)}}" method="post" id="myForm">  
                    @csrf 
                        <div class="add_item">
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                        ...
                                        <select name="class_id"  id="fee_category" class="form-control">
                                            ...
                                            <option value="{{$classes->id}}" {{$data[0]->class_id==$classes->id?"selected":""}}>{{$classes->name}}</option>
                                            @endforeach
                                        </select>
                                        @error('class_id')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                            ...
                                            <select name="subject_id[]"  id="class" class="form-control">
                                                ...
                                                <option value="{{$subjects->id}}" {{$edata->subject_id==$subjects->id?"selected":""}}>{{$subjects->name}}</option>
                                                @endforeach
                                            </select>
                                    </div>
                                    <div class="form-group col-md-2">
                                            <label for="amount">Full Mark</label>
                                            <input type="text" id="amount" name="full_mark[]" class="form-control" value="{{$edata->full_mark}}">
                                            @error('full_mark')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                    </div>
                                    <div class="form-group col-md-2">
                                            ...
                                            <input type="text" id="amount" name="pass_mark[]" class="form-control" value="{{$edata->pass_mark}}">
                                            @error('pass_mark')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                    </div>
                                    <div class="form-group col-md-2">
                                            ...
                                            <input type="text" id="amount" name="get_mark[]" class="form-control" value="{{$edata->get_mark}}">
                                            @error('get_mark')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                                    </div>
...
$(function () {
  $('#myForm').validate({
    ...
    messages: {
      ...
      "get_mark[]": {
        required: "Please Provide Get Mark",
        number: "Please Provide a Digit Mark",
      },
    },
    errorElement: 'span',
