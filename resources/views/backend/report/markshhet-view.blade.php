        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  <form id="myForm" method="get" action="{{route('report.marksheet.get')}}">
                      @csrf
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                             ...
                             <div class="form-group col-md-3">
                                ...
                                <input type="text" id="id_no" name="id_no" class="form-control form-control-sm" placeholder="Enter ID No">
                            </div>
