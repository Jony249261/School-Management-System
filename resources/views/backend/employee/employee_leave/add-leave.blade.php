        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{route('employee.leave.store')}}" method="post" id="myForm">
                    @csrf 
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" id="join_date" name="start_date" class="form-control form-control-sm singledatepicker" placeholder="Enter Your Join Date" autocomplete="off">
                            @error('start_date')
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" id="join_date" name="end_date" class="form-control form-control-sm singledatepicker" placeholder="Enter Your Join Date" autocomplete="off">
                            @error('end_date')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
