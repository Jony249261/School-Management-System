        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{route('employee.registration.update',$data->id)}}" method="post" id="myForm" enctype="multipart/form-data">
                    @csrf 
                    <div class="form-row">
                        
                        <div class="form-group col-md-4">
                            <label for="name">Employee Name <font style="color:red">*</font> </label>
                            <input type="text" id="name" name="name" class="form-control form-control-sm" value="{{$data->name}}">
                            @error('name')
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="fname" name="fname" class="form-control form-control-sm" value="{{$data->fname}}">
                            @error('fname')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="mname" name="mname" class="form-control form-control-sm" value="{{$data->mname}}">
                            @error('mname')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="mobile" name="mobile" class="form-control form-control-sm" value="{{$data->mobile}}">
                            @error('mobile')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="address" name="address" class="form-control form-control-sm" value="{{$data->address}}">
                            @error('address')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="religion"  id="religion" class="form-control form-control-sm">
                                ...
                                <option value="Khistan" {{$data->religion=='Khistan'?"Selected":""}}>Khistan</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="designation_id"  id="designation_id" class="form-control form-control-sm">
                                ...
                                <option value="{{$designations->id}}"  {{$designations->id==$data->designation_id?"selected":""}}>{{$designations->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                           <img id="showImage" src="{{(!empty($data->image))?url('public/upload/employee_images/'.$data->image):url('public/upload/noimage.jpg')}}" alt="" style="width:100px; height:100px; border:1px solid #000">
