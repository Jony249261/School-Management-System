            ...
            <div class="card">
              <div class="card-header bg-primary">
                <h3>
                  ...
                  <a href="{{route('employee.attendence.view')}}" class="btn btn-success float-right"><i class="fas fa-plus-circle mr-1"></i>Employee Attendence List</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
